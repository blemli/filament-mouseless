...
class ActionMeta
{
    protected const ICONS = [
        ...
        'crud.force-delete' => 'heroicon-o-fire',
        'crud.restore' => 'heroicon-o-arrow-uturn-left',
        'crud.save' => 'heroicon-o-check',
        'crud.submit' => 'heroicon-o-paper-airplane',
        'crud.create-another' => 'heroicon-o-plus-circle',
        'crud.cancel' => 'heroicon-o-x-mark',
        'crud.view' => 'heroicon-o-eye',
        'crud.duplicate' => 'heroicon-o-document-duplicate',
        'crud.attach' => 'heroicon-o-link',
        'crud.detach' => 'heroicon-o-link-slash',
        'list.search' => 'heroicon-o-magnifying-glass',
        'list.filter' => 'heroicon-o-funnel',
        'list.group' => 'heroicon-o-rectangle-group',
        'list.sort' => 'heroicon-o-arrows-up-down',
        'list.columns' => 'heroicon-o-view-columns',
        ...
        'record.split' => 'heroicon-o-scissors',
        'record.copy-markdown' => 'heroicon-o-clipboard-document',
        'record.favorite' => 'heroicon-o-bookmark',
        'record.watch' => 'heroicon-o-bell-alert',
        'record.lock' => 'heroicon-o-lock-closed',
        'record.share' => 'heroicon-o-share',
        ...
        'nav.language' => 'heroicon-o-language',
